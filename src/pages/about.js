  ...
  <section className="row">
    <div className="column medium-text">
      ...
      <ul className="padding-bottom">
        ...
        <li><span className="description">Props to the talented <a href="https://www.linkedin.com/in/peter-loveland-75a73294/">Peter Loveland</a> for his Gatsby help (and puns) along the way.</span></li>
      </ul>

  ...
  <section className="row">
    <div className="column">
      ...
      <ul className="padding-bottom">
        ...
        <li>I also used the <a href="https://tailwindcss.com/">Tailwind</a> utility-first CSS framework and their <a href="https://github.com/taylorbryant/gatsby-starter-tailwind">Gatsby starter theme</a>.</li>
        ...
        <li>I use <a href="https://www.google.com/analytics">Google Analytics</a> to analyse site traffic. Thanks to both my visitors! 😉</li>

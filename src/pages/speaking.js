    ...
    <Layout fullWidth={true}>
      ...
      <ContentWidth bgColour="3">
        <section className="row">
          ...
          <div className="column">
            ...
            <p className="conferenceLocation">
              <em>Online, May 2021</em>
            </p>
            <p className="">
              I co-presented with my awesome colleague Maranda Bodas on the
              ongoing content design transformation within IBM, and in
              particular how we've grown a grass-roots content design community
              of practice that has helped bring together content practitioners
              and advocates from across the company.
            </p>
            <p>
      ...
      <ContentWidth bgColour="2">
        <section className="row reverse">
          <div className="column">
            ...
            <p className="conferenceName">
              Product content strategy event organised by 383 Project
            </p>
            <p className="conferenceLocation">
              <em>Online, Dec 2020</em>
            </p>
            <p className="">
              At this online event for product designers, strategists, owners,
              and managers I presented on the importance of having a suitable,
              engaging, and consistent voice and tone. I also shared a fun
              exercise that I've used in the past to help product teams see for
              themselves just what a huge impact the voice and tone of a product
              has on the overall user experience.
            </p>
          </div>
          <div className="column">
            <img
      ...
      <ContentWidth bgColour="1">
        <section className="row">
          ...
          <div className="column">
            ...
            <p className="conferenceLocation">
              <em>Online, Oct 2020</em>
            </p>
            <p className="">
              We all want to deliver delightful content experiences, but how can
              you ensure quality and consistency across a customer’s end-to-end
              content journey when that content is created by thousands of
              people, across hundreds of teams, based all over the world? In
              this talk I shared some useful tips and practices to help break
              down content silos.
            </p>
          </div>
        </section>
      ...
      <ContentWidth bgColour="2">
        <section className="row reverse">
          <div className="column">
            ...
            <p className="">
              A few years ago I started a cross-company Content Design Guild at
              IBM, which is still going strong and in this talk I shared some
              practical tips on how to develop and scale a cross-functional
              content practice.
            </p>
          </div>
          <div className="column">
      ...
      <ContentWidth bgColour="2">
        <section className="row reverse">
          <div className="column">
            <p className="conference">
              Failing fast, using feedback loops, and the benefits of iterative
              design
            </p>
            <p className="conferenceName">IBM Think conference</p>
            <p className="conferenceLocation">
              <em>Las Vegas, USA, Mar 2018</em>
            </p>
            <p className="">
              This session introduced the audience to some of the key concepts
              behind the Lean Startup and design thinking approaches. I helped
              explain the value of treating decisions like hypotheses to be
              tested, and how establishing feedback loops helps us to learn,
              refine or pivot, and ultimately increases our chances of success.
            </p>
            <p>
              You can read more about this topic in{" "}
              <a
                href="https://medium.com/design-ibm/failing-fast-using-feedback-loops-and-the-benefits-of-iterative-design-e0b86d037f50"
                rel="noopener noreferrer"
                target="_blank"
              >
                this article
      ...
      <ContentWidth bgColour="1">
        <section className="row">
          ...
          <div className="column">
            ...
            <p className="conferenceLocation">
              <em>Las Vegas, USA, Mar 2017</em>
            </p>
            <p className="">
              In this talk I demonstrated the benefits of having a consistent
              design language across your portfolio of offerings and I shared

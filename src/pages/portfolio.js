...
<section className="row">
    <div className="column">
      ...
      <p><em>Examples of some of my recent work. (See also my <Link to="/articles">articles</Link>, <Link to="/experience">experience and skills</Link> and <Link to="/testimonials">testimonials</Link>.)</em></p>
    </div>
  </section>
</ContentWidth>
    ...
    <div className="column panel medium-text">
      <ul>
        ...
        <li>As well as helping to improve the in-product content, I also helped the team design a new 
          set of <a href="https://www.ibm.com/cloud/event-streams" target="_blank" rel="noopener noreferrer">marketing pages</a>.</li>
        <li>The team won an <a href="https://www.indigoawards.com/winners/731" target="_blank" rel="noopener noreferrer">external design award</a> 🏆 for the product and a 
        ...
        the <a href="https://ibm.github.io/event-automation/es/" target="_blank" rel="noopener noreferrer">product docs site</a>.</li>
      </ul>
    </div>
  </section>
</ContentWidth>
  ...
  <section className="row">
    <div className="column panel medium-text">
      <ul>
        ...
        <li>Later, as IBM moved to using the awesome <a href="https://www.carbondesignsystem.com/" target="_blank" rel="noopener noreferrer">Carbon Design System</a> for 
        all of its product UIs, I began contributing to the <a href="https://www.carbondesignsystem.com/guidelines/content/overview" target="_blank" rel="noopener noreferrer">content guidelines</a> within Carbon.</li>
    ...
    <div className="column">
      <img className="panel-images"
        ...
        src={Carbon_image}
      />
      <p className="caption-text">Carbon Design System &gt; <a href="https://www.carbondesignsystem.com/guidelines/content/overview" target="_blank" rel="noopener noreferrer">Content guidelines</a></p>
    </div>
  </section>
</ContentWidth>

      ...
      <ContentWidth>
          ...
          <div className="column books">
            ...
            <p>
              <em>
                ...
                last few years. For each book I’ve provided a link to further
                information and written a one-sentence description.
              </em>
            </p>
            <ul className="ul-small do-not-print">
              <li>
                <a href="#content">Content design / writing books</a>
              </li>
              <li>
                <a href="#non-fiction">Design / growth / leadership books</a>
              </li>
            </ul>
            <p>
              <em>
                If you also enjoy reading fiction, do check out{" "}
                <Link to="/reading">this page</Link>.
              </em>
            </p>
          </div>
          ...
          <div className="column books">
            ...
            <ul>
              <li>
                ...
                <p>
                  A nice introduction to some of the main approaches we can use
              ...
              <li>
                ...
                <p>
                  Some good advice on how to create a strong and respected
              ...
              <li>
                ...
                <p>
                  Part memoir, part writing masterclass, and an all round
                  entertaining read (as you’d expect).
                </p>
              </li>
              <li>
                ...
                <p>
                  A call-to-action to focus more consciously on the words,
                  sounds, and rhythms that make up our sentences.
                </p>
              </li>
              <li>
                ...
                <p>
                  Lots of good advice about assessing and developing content
                  maturity, skills, and teams.
                </p>
              </li>
              <li>
                ...
                <p>
                  A really helpful book (with an apt title) covering most of the
                  core areas of writing for digital products.
                </p>
              </li>
              <li>
                ...
                <p>
                  A really practical book on creating frameworks and patterns
              ...
              <li>
                ...
                <p>
                  I work as a Content Designer, so it’s perhaps no surprise that
                  I’m a big fan of this little book.
                </p>
              </li>
              <li>
                ...
                <p>
                  One of the definitive books on writing style that’s still
                  useful 100 years on.
                </p>
              </li>
              <li>
                ...
                <p>
                  A fun book about the importance of punctuation in everyday
                  writing.
                </p>
              </li>
              <li>
                ...
                <p>
                  Quite an old book now, but it contains some useful prompts and
        ...
        <section>
          <div className="booksToRead">
            ...
            <ul>
              <li>
                <em>The Content Strategy Toolkit</em> (2015) by Meghan Casey
              </li>
              <li>
                <em>Conversational Design</em> (2018) by Erika Hall
              </li>
              <li>
                <em>Writing for Designers</em> (2018) by Scott Kubie
              </li>
              <li>
                <em>Leading Content Design</em> (2022) by Rachel McConnell
              </li>
            </ul>
          </div>
        </section>
          ...
          <div className="column books">
            ...
            <ul>
              <li>
                ...
                <p>
                  I’m fascinated by the extent to which we tend to deceive
                  ourselves, so was naturally drawn to this intriguing volume.
                </p>
              </li>
              <li>
                ...
                <p>
                  Books about being brave, trying, failing, rising again,
                  dusting ourselves off, owning our stories — and helping others
                  do the same.
                </p>
              </li>
              <li>
              ...
              <li>
                ...
                <p>
                  If you’ve never read this seminal book, do yourself a huge
                  favour and go beg, borrow, or steal a copy today.
                </p>
              </li>
              <li>
                ...
                <p>
                  A very readable exploration into how some seemingly small
                  things can lead to major change.
                </p>
              </li>
              <li>
                ...
                <span className="black-text"> by Malcolm Gladwell</span>
                <p>
                  A book about underdogs and the many areas of life in which
              ...
              <li>
                ...
                <p>
                  A thorough and fascinating study into how groups of people can
                  learn to better collaborate together.
                </p>
              </li>
              <li>
                ...
                <p>
                  An exploration into the different modes of thinking ("fast"
                  and "slow") and the cognitive biases associated with each.
                </p>
              </li>
              <li>
                ...
                <span className="black-text">
                  {" "}
                  by G. Kim, K. Behr, and G. Spafford
                </span>
                <p>
                  A good portrayal of life inside a siloed IT department and
                  what DevOps really has to offer.
                </p>
              </li>
              <li>
                ...
                <p>
                  ...
                  prototyping, testing, and getting feedback — all within 5
                  days.
                </p>
              </li>
              <li>
                ...
                <p>
                  Applying economic theories to some of life’s many riddles,
                  such as why do drug dealers still live at home with their
                  moms?
                </p>
              </li>
              <li>
                ...
                <p>
                  This book was way ahead of its time when it was published in
                  1988 and is still worth a read today.
                </p>
              </li>
              <li>
                ...
                (2018)
                <span className="black-text"> by Jordan Peterson</span>
                <p>
                  A fascinating mixture of ethical principles, psychology,
                  mythology, religion, and day-to-day life advice.{" "}
                </p>
              </li>
              <li>
                ...
                <p>
                  A good introduction to the core concepts and practices of
              ...
              <li>
                ...
                <p>
                  A fact-based, enlightening, and hope-filled book about what
              ...
              <li>
                ...
                <p>
                  I read this a couple of years ago and it has definitely had a
                  huge impact on how I now approach any new venture.
                </p>
              </li>
              <li>
                ...
                <p>
                  How being really clear about your "why" helps you to better
                  communicate with and inspire others.
                </p>
              </li>
              <li>
              ...
              <li>
                ...
                <p>
                  A great introduction to coaching, the GROW model, and how to
                  help raise awareness and responsibility.
                </p>
              </li>
            </ul>
          </div>
        ...
        <section>
          <div className="booksToRead">
            ...
            <ul>
              <li>
                <em>Getting Things Done</em> (2001) by David Allen
              </li>
              <li>
                <em>Made to Stick</em> (2007) by Chip and Dan Heath
              </li>
              <li>
                <em>The Laws of Simplicity</em> (2006) by John Maeda
              </li>
              <li>
                <em>Thinking in Systems</em> (2008) by Donella Meadows
              </li>
            </ul>
          </div>
        </section>

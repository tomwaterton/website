      ...
      <ContentWidth>
        <section className="row">
          <div className="column">
            <h1 className="do-not-print">Cryptic crossword #06</h1>

            <p className="do-not-print">
              <em>
                If you have any feedback on this crossword or would like clues
                or answers, do{" "}
                <a href="mailto:tomwaterton@gmail.com?Subject=Re%20your%20cryptic%20crossword%20number_06">
                  get in touch
                </a>{" "}
                with me.
              </em>
...
export const Head = () => (
  <SEO
    ...
    title="Tom Waterton's website: Cryptic crossword #06"
  />
);
